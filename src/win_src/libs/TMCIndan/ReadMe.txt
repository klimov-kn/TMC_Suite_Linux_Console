========================================================================
    STATIC LIBRARY : TMCIndan Project Overview
========================================================================

AppWizard has created this TMCIndan library project for you. 
This file contains a summary of what you will find in each of the files that
make up your TMCIndan application.
...
StdAfx.h, StdAfx.cpp
    ...
    named TMCIndan.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "TMCIndan.rc" and a "TMCIndan.h" that 
